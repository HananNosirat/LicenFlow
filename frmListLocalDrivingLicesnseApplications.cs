    ...
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void frmListLocalDrivingLicesnseApplications_Load_1(object sender, EventArgs e)
        {
            ...
            if (dgvLocalDrivingLicenseApplications.Rows.Count > 0)
            {
                ...
                dgvLocalDrivingLicenseApplications.Columns[1].Width = 230;
                ...
                dgvLocalDrivingLicenseApplications.Columns[4].Width = 145;
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (LocalApp != null)
            {
                frmLocalDrivingLicenseApplicationInfo frm = new frmLocalDrivingLicenseApplicationInfo(LocalApp.ApplicationID);
                frm.ShowDialog();
            }
            //refresh
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmAddUpdateLocalDrivingLicesnseApplication frm = new frmAddUpdateLocalDrivingLicesnseApplication(LocalApp.LocalDrivingLicenseApplicationID);
            frm.ShowDialog();
            _Refresh();
        }
