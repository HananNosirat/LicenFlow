...
namespace firstTrying.Controls
{
    public partial class ctrlScheduleTest : UserControl
    {
                    ...
                    case clsTestType.enTestType.VisionTest:
                        {
                            ...
                            pbTestTypeImage.ImageLocation = @"C:\Users\hanan\source\repos\firstTrying\resources\Vision 512.png";
                            break;
                        }
                    ...
                    case clsTestType.enTestType.WrittenTest:
                        {
                            gbTestType.Text = "Written Test";
                               pbTestTypeImage.ImageLocation = @"C:\Users\hanan\source\repos\firstTrying\resources\Written Test 512.png";
                            break;
                        }
                    case clsTestType.enTestType.StreetTest:
                        {
                            gbTestType.Text = "Street Test";
                            pbTestTypeImage.ImageLocation = @"C:\Users\hanan\source\repos\firstTrying\resources\driving-test 512.png";
                            break;
           ...
           public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            {
                MessageBox.Show("there is No Application.");
                return;
            }
            ...
            // 1. دائماً نقوم بجلب الرسوم الأساسية للاختبار أولاً لأنها ثابتة ومطلوبة في الحالتين
            lblFees.Text = clsTestType.Find(_TestTypeID).Fees.ToString();

            // 2. التحكم في حقول إعادة الاختبار بناءً على حالة الطلب
            ...
            {
                lblRetakeAppFees.Text = "0"; // نضع صفر حتى لا يتبقى الحقل فارغاً ويسبب خطأً عند الحساب
                gbRetakeTestInfo.Visible = false;
                lblTitle.Text = "Schedule Test";
            }

            // 3. حساب إجمالي الرسوم بشكل آمن تماماً وعرضه للمستخدم
        ...
        private void btnSave_Click_1(object sender, EventArgs e)
        {
            ...
            _TestAppointment.PaidFees = (float)Convert.ToDecimal(lblFees.Text);
